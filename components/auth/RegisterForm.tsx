...
import { GraduationCap, ArrowRight, Eye, EyeOff, Lock, Mail, User, ShieldCheck, AlertCircle, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-sm space-y-5">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-slate-600">Enter your details to get started with LearnOS.</p>
      </div>
